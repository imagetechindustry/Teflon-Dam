export const productsData = [
  {
    id: "teflon-dam-for-nord-super-simplex-and-super-combi",
    slug: "teflon-dam-for-nord-super-simplex-and-super-combi",
    name: "Teflon Dam for Nord Super Simplex & Super Combi",
    shortDescription: "Teflon Dam for Nord Super Simplex and Super Combi is a machine-specific accessory designed for use in solventless lamination machines.",
    externalLink: "https://www.imagetechindustries.com/products/teflon-dam-for-nord-super-simplex-super-combi",
    images: [
    ...
    keyFeatures: [
      ...
      "Smooth Surface Finish for Consistent Flow",
      "Highly Resistant to Wear and Tear",
      "Ensures Uniform Application Across the Web",
      "Manufactured to Strict Global Quality Standards"
    ],
    applications: "This Teflon Dam is exclusively used as an essential accessory in Nord Super Simplex and Nord Super Combi solventless lamination machines. It is highly suitable for flexible packaging industries, industrial converting applications, and high-speed laminating setups where precision and continuous operation are critical to maintaining production quality.",
    specifications: [
      { label: "Product Type", value: "Teflon Dam Accessory" },
      { label: "Compatible Machine", value: "Nord Super Simplex & Super Combi" },
      ...
      { label: "Manufacturing Standard", value: "ISO 9001:2015 Certified" }
    ],
    faqs: [
      { question: "What is the primary use of a Teflon Dam?", answer: "A Teflon Dam is a crucial accessory used in solventless lamination machines to control and contain the adhesive flow, ensuring smooth and uniform application during the packaging process." },
      { question: "Can I use this Teflon Dam on other machines?", answer: "No, this specific model is precision-engineered exclusively for Nord Super Simplex and Nord Super Combi machines to guarantee a perfect fit." },
  ...
  },
  {
    ...
    slug: "teflon-dam-for-bobst",
    name: "Teflon Dam for Bobst Lamination Machine",
    shortDescription: "Teflon Dam for Bobst is a machine-specific accessory designed for use in Bobst solventless lamination machines.",
    externalLink: "https://www.imagetechindustries.com/products",
    images: [
      "/teflon-dam/nord-super-simplex.png"
    ],
    overview: "Teflon Dam for Bobst Lamination Machine is a machine-specific accessory used in solventless lamination equipment. It is designed according to the machine configuration to provide a suitable fit during the lamination process.",
    ...
    keyFeatures: [
      ...
      "Lowers Overall Machine Maintenance Costs",
      "Enhances Final Flexible Packaging Quality",
      "Machine-Specific Dimensions for Perfect Fit"
    ],
    applications: "Specifically designed for use in Bobst solventless lamination equipment. This Teflon Dam is widely utilized by major flexible packaging manufacturers, industrial printing houses, and advanced converting facilities that rely on Bobst machinery for high-speed, flawless lamination.",
    specifications: [
      { label: "Product Type", value: "Teflon Dam Accessory" },
    ...
    faqs: [
      { question: "Why should I use a machine-specific Teflon Dam for my Bobst?", answer: "Bobst machines operate at very high speeds and require precise tolerances. A machine-specific Teflon Dam ensures exactly the right fit, preventing adhesive leaks and avoiding costly mechanical damage." },
      { question: "How does this Teflon Dam improve productivity?", answer: "By fitting perfectly and being made of high-quality materials, it lasts longer and requires fewer replacements. This means your Bobst machine spends more time running and less time stopped for maintenance." },
  ...
  },
  {
    ...
    slug: "teflon-dam-for-uteco",
    name: "Teflon Dam for Uteco Lamination Machine",
    shortDescription: "Teflon Dam for Uteco is a machine-specific accessory designed for use in Uteco solventless lamination machines.",
    externalLink: "https://www.imagetechindustries.com/products",
    images: [
      "/teflon-dam/nord-super-simplex.png"
    ],
    ...
    keyFeatures: [
      ...
      "Quick to Remove and Replace",
      "Protects Expensive Machinery Components",
      "Ideal for Heavy-Duty Converting Operations",
      "Verified by Strict Quality Control Standards"
    ],
    applications: "This model is utilized exclusively as a critical accessory for Uteco solventless lamination machines. It is the preferred choice for industrial converting businesses and packaging manufacturers seeking to maintain high-quality output and reliable operation on their Uteco lines.",
    specifications: [
      { label: "Product Type", value: "Teflon Dam Accessory" },
    ...
    faqs: [
      { question: "Is this Teflon Dam exactly matching Uteco specifications?", answer: "Yes, this model is precision-crafted to align perfectly with the unique dimensional and operational requirements of Uteco solventless laminators." },
      { question: "What happens if I use a generic Teflon Dam instead?", answer: "Generic accessories often fit poorly, leading to adhesive leakage, uneven lamination, and potential damage to your expensive Uteco machinery. Always use a machine-specific model." },
  ...
  },
  {
    ...
    slug: "teflon-dam-for-comexi",
    name: "Teflon Dam for Comexi Lamination Machine",
    shortDescription: "Teflon Dam for Comexi is a machine-specific accessory designed for use in Comexi solventless lamination machines.",
    externalLink: "https://www.imagetechindustries.com/products",
    images: [
      "/teflon-dam/nord-super-simplex.png"
    ],
    overview: "Teflon Dam for Comexi Lamination Machine is a machine-specific accessory used in solventless lamination equipment.",
    detailedDescription: `Teflon Dam is a highly specialized accessory that plays a vital role in the efficient operation of solventless lamination machine setups. This specific model is meticulously engineered and manufactured for **Comexi Lamination Machines**, ensuring a seamless fit and superior, consistent performance across all lamination tasks.\n\nComexi machines are renowned for their precision and speed, and they require accessories that can match their high standards. Our Teflon Dam for Comexi is designed with these exact specifications in mind, providing a machine-specific solution that outperforms generic alternatives in durability and fit.\n\n**Reliability for Continuous Production**\nIn high-volume flexible packaging operations, reliability is key. This Teflon Dam is built to endure continuous use in Comexi solventless laminators. It is designed for straightforward installation and replacement, allowing maintenance crews to perform necessary servicing swiftly and effectively.\n\n**The Machine-Specific Advantage**\nBy choosing a Teflon Dam explicitly designed for Comexi equipment, you eliminate the risks associated with improper fitment. This ensures smooth operations, protects your machinery, and maintains the highest standards of lamination quality in your converting applications.`,
    keyFeatures: [
      "Tailor-Made for Comexi Lamination Machines",
      "High-Performance Teflon Material",
      "Flawless Dimensional Accuracy",
      "Supports Ultra-High-Speed Lamination",
      "Prevents Unwanted Adhesive Leaks",
      "Streamlines Preventive Maintenance",
      "Ensures Uniform Packaging Quality",
      "Reduces Overall Operational Costs",
      "Ready for Immediate Drop-In Use"
    ],
    applications: "Engineered specifically for Comexi solventless lamination setups. This Teflon Dam is a must-have for high-volume flexible packaging operations, enabling continuous, high-speed production runs without compromising on lamination quality or machinery health.",
    specifications: [
      { label: "Product Type", value: "Teflon Dam Accessory" },
