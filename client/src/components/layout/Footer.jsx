        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mb-6 leading-relaxed font-medium">
              We are a leading supplier of high-quality machine-specific Teflon Dams for solventless lamination applications. Our commitment to quality, innovation, and customer satisfaction drives everything we do.
            </p>
