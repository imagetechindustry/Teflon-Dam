      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {websites.map((site) => (
            <div
              key={site.domain}
              className="bg-slate-50/70 hover:bg-white rounded-2xl border border-slate-200/90 hover:border-blue-400 p-6 sm:p-7 flex flex-col justify-between shadow-xs hover:shadow-xl transition-all duration-300 group relative"
            >
              <div>
                {/* Card Top: Icon & Badge */}
                <div className="flex items-center justify-between mb-5">
                  <div className="w-12 h-12 rounded-xl bg-white border border-slate-200 text-blue-600 flex items-center justify-center shadow-xs group-hover:scale-105 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                    {site.icon}
                  </div>
                  <span
              ...
              <div className="pt-4 border-t border-slate-200/80 flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-blue-600 hover:text-blue-800 bg-blue-50/70 hover:bg-blue-100 px-3.5 py-1.5 rounded-lg transition-colors cursor-pointer group-hover:translate-x-0.5"
                >
                  Visit Website
                  <svg
