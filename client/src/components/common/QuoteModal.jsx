...
/* ─────────────────────────────────────────────────────────────────────────────
   INLINE SVG ICONS (Self-contained, zero external dependency)
   ───────────────────────────────────────────────────────────────────────────── */
      ...
      <div className="relative w-full max-w-[1050px] bg-white rounded-[24px] shadow-[0_20px_60px_rgba(0,0,0,0.4)] overflow-hidden animate-scaleUp flex flex-col md:flex-row max-h-[95vh] md:max-h-[85vh] overflow-y-auto md:overflow-hidden">
        ...
        <div className="flex w-full md:w-[55%] relative flex-col justify-between overflow-hidden bg-white shrink-0 min-h-[380px] md:min-h-0 pt-2 md:pt-0">
          ...
          <div className="relative z-20 px-6 md:px-8 pt-4 md:pt-8 flex-1 flex flex-col">
            ...
            {/* Line separator */}
            <div className="w-12 h-1 bg-blue-600 mb-3 md:mb-4 rounded-full z-20 relative" />
            ...
            <div className="flex gap-4 sm:gap-6 justify-start pb-6 md:pb-0 relative z-20">
              <div className="flex flex-col items-center text-center">
                <div className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center mb-1.5 bg-white shadow-sm text-blue-600">
          ...
          {/* Bottom Dark Stats Bar (#1e293b with primary color top border) */}
          <div className="relative z-20 bg-[#1e293b] w-full h-[72px] px-2 flex items-center justify-between border-t-[3px] border-blue-600 mt-auto">
        ...
        <div className="w-full md:w-[45%] bg-white p-6 md:p-8 relative flex flex-col shrink-0 md:shrink overflow-y-auto">
          ...
          <div className="mb-6 pr-8">
            <div className="flex items-center gap-2 text-blue-600 font-black text-[10px] tracking-widest uppercase mb-2">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight leading-tight">
              Get Your <span className="text-blue-600">Custom</span> Quote
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-4.5 flex-1 flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
              <div className="space-y-1.5">
                <label className="flex items-center gap-1.5 text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                  <UserIcon className="w-3.5 h-3.5 text-slate-400" /> Full Name <span className="text-blue-600">*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-3.5 py-2.5 text-sm font-semibold text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all placeholder-slate-400"
              ...
              <div className="space-y-1.5">
                <label className="flex items-center gap-1.5 text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                  <BuildingIcon className="w-3.5 h-3.5 text-slate-400" /> Company Name <span className="text-blue-600">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
              <div className="space-y-1.5">
                <label className="flex items-center gap-1.5 text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                  <MailIcon className="w-3.5 h-3.5 text-slate-400" /> Email Address <span className="text-blue-600">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
              ...
              <div className="space-y-1.5">
                <label className="flex items-center gap-1.5 text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                  <PhoneIcon className="w-3.5 h-3.5 text-slate-400" /> Phone Number <span className="text-blue-600">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
            ...
            <div className="space-y-1.5">
              <label className="flex items-center gap-1.5 text-[10px] font-bold text-slate-700 uppercase tracking-wider">
                <PackageIcon className="w-3.5 h-3.5 text-slate-400" /> Product / Requirement <span className="text-blue-600">*</span>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all placeholder-slate-400"
                  placeholder="e.g. Nordmeccanica Teflon Dam, Bobst Teflon Dam"
                />
                <datalist id="product-suggestions">
                  <option value="Nordmeccanica Teflon Dam" />
                  <option value="Bobst Teflon Dam" />
                  <option value="Uteco Teflon Dam" />
                  <option value="Comexi Teflon Dam" />
                  <option value="Custom Lamination Machine Dam" />
                </datalist>
              </div>
            </div>
            ...
            <div className="space-y-1.5 flex-1">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm font-semibold text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all resize-none placeholder-slate-400 min-h-[75px]"
